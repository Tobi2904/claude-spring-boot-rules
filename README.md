...
> **Built on prior art.** Rules #1–#4 are adapted from [`forrestchang/andrej-karpathy-skills`](https://github.com/forrestchang/andrej-karpathy-skills) (MIT, © Forrest Chang), themselves derived from Andrej Karpathy's observations on LLM coding pitfalls. Rules #5–#14 are original additions for Spring Boot / Java backend conventions. See [`NOTICE`](./NOTICE) for full attribution.
...
This repo **extends** the Karpathy guidelines with 10 additional rules that fix these Spring Boot–specific defaults. Opinionated for Java/Spring Boot 3.x projects.
...
| File | Purpose |
|------|---------|
| [`CLAUDE.md`](./CLAUDE.md) | The 14 rules. Drop into your project root, Claude Code reads it automatically. |
